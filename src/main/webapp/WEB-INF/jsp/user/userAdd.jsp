    ...
    <div class="x-body">
        <form action="userAddDo" method="post" enctype="multipart/form-data" class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="user_account" name="user_account" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <c:forEach items="${roleAllList }" var="role">
                        <input type="radio" value="${role.role_id }" name="fk_role_id" lay-skin="primary" title="${role.role_name }" checked="checked">
                    </c:forEach>
                </div>
            </div>
